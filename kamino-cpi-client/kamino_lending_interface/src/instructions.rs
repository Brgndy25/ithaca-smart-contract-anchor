...
pub fn withdraw_protocol_fee_verify_writable_privileges<'me, 'info>(
    ...
    for should_be_writable in [
        accounts.reserve_liquidity_mint,
        accounts.fee_vault,
        accounts.lending_market_owner_ata,
    ] {
        if !should_be_writable.is_writable {
            return Err((should_be_writable, ProgramError::InvalidAccountData));
        }
...
for RefreshObligationFarmsForReserveKeys {
    fn from(
        ...
        Self {
            ...
            lending_market_authority: pubkeys[2],
            reserve: pubkeys[3],
            reserve_farm_state: pubkeys[4],
            obligation_farm_user_state: pubkeys[5],
...
for RefreshObligationFarmsForReserveAccounts<'me, 'info> {
    fn from(
        ...
        Self {
            ...
            lending_market_authority: &arr[2],
            reserve: &arr[3],
            reserve_farm_state: &arr[4],
            obligation_farm_user_state: &arr[5],
...
pub fn borrow_obligation_liquidity_verify_writable_privileges<'me, 'info>(
    ...
    for should_be_writable in [
        ...
        accounts.borrow_reserve_liquidity_mint,
...
>(
    ...
    for should_be_writable in [
        accounts.obligation,
        accounts.repay_reserve,
        accounts.repay_reserve_liquidity_mint,
        accounts.repay_reserve_liquidity_supply,
        accounts.withdraw_reserve,
        accounts.withdraw_reserve_liquidity_mint,
